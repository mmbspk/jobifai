-- +goose Up
-- Reclassify Cannot Apply rows that are really manual-apply jobs (external ATS,
-- bot protection, mis-detected Easy Apply) into Top Matches.
